...
class Conversations extends Component {
    ...
    render() {
        return ( <
            ...
            p className = "lead" > Model responses
            for a given dataset are available to view and compare against other models.First, select an evaluation dataset and add the models that support the dataset that you wish to compare(you can compare multiple models at once). <
            /p>
            ...
            <
            h2 > Dataset < /h2> <
            Select options = { this.props.evalsets }
            className = "vmargin"
            ...
            <
            button className = "btn btn-primary vmargin"
            onClick = { this.updateTurns } > Update Conversation < /button>

            <
            br / > < br / >
            <
            TurnList prompts = { this.state.prompts }
