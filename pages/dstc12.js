      ...
      <div>
        ...
        <main role="main" className="container">
          ...
          <h2 className="mt-5 font-weight-bold">Track 1: Dialog System Evaluation: Dimensionality, Language, Culture and Safety</h2>
            <br/>
            <p>Click <a href="https://forms.gle/J8GrZchnFEacJ7Y47">here</a> to register for DSTC12.T1.<span style={{color: 'green'}}> (now available)</span></p>
            <hr/>
          ...
          <h3 className="font-weight-bold">Track Overview</h3>
            ...
            <ul>
              <li id="provided-datasets"><b>Basline</b></li>
            </ul>
            <p style={{marginLeft: 60 + 'px'}} align='justify'>
            ...
            <ul>
              <li id="provided-datasets"><b>Baseline</b></li>
            </ul>
            <p style={{marginLeft: 60 + 'px'}} align='justify'>
            As a baseline, <a href="https://huggingface.co/meta-llama/Llama-Guard-3-1B">Llama-Guard-3-1B</a> will be used. This model is a fine-tuned Llama-3.2-1B pretrained model for content safety classification.
            </p>
          ...
          <h3 className="font-weight-bold">Schedule</h3>
            <br/>
            <ul>
              <li><b>Training/Validation data release</b>: Jan 3, 2025</li>
              <li><b>Test data release</b>: Mar 21, 2025</li>
              <li><b>Entry submission deadline</b>: Mar 28, 2025 (23:59 Anywhere on Earth (AoE), UTC-12)</li>
              <li><b>Final result announcement</b>: Apr 7, 2025</li>
              <li><b>Paper submission</b>: June 2025</li>
              <li><b>Workshop</b>: September 2025</li>
            </ul>
            <hr/>
